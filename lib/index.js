  ...
  System.reload = (moduleName, options = {}) => {
    ...
    return _.lock = _.lock.then(() => {
      ...
      return resolve(moduleName)
        .then(name => findDependants(name, options.entries))
            ...
            return resolve(dependent)
              .then(dependent => {
                if (
                  ...
                  typeof System.get(dependent).__reload == 'function'
                ) {
          ...
          // })
            ...
            .then(() => {
              ...
              // resolve all entries
                ...
                .map(entry => System.import(entry).catch(err => console.error(err)))
                // Print any errors
              ...
              if (usedReload)
                console.warn('Exporting __reload to reload your module is deprecated, you need to follow the steps',
                  'here to upgrade')
            })
        })
